...
function meObj(first, last, lovesDevMountain, learnES6) {
	return {
		first,
		last,
		lovesDevMountain,
...
let me = meObj(first, last, true, () => 'This is awesome!');
...
// using computed property names create a new object named
//flipped where the keys are your first and last name
...
const toPower = (number, exponent=2) => number ** exponent; //double star ES6
